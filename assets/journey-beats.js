...
(() => {
  ...
  window.ICHJourneyBeats=[
    ...
    {id:'06',name:'流星穿越',kind:'scene',end:2.161,seconds:unfolding(.861)},
    {id:'07',name:'撞擊與碎片',kind:'scene',end:2.32,seconds:unfolding(.159)},
    {id:'08',name:'機芯浮現',kind:'scene',end:2.62,seconds:unfolding(.30)},
    {id:'09',name:'完整機芯停留',kind:'scene',end:2.94,seconds:unfolding(.32)},
    {id:'10',name:'機芯展開',kind:'scene',end:3.50,seconds:unfolding(.56)},
